...
export const AUTHORS: Author[] = [
  {
    ...
    avatarUrl: "https://oulhpalutjqwmbhbvjkj.supabase.co/storage/v1/object/public/avatars/madred-avatar.png.jpg",
    socials: {
  ...
  avatarUrl: "https://oulhpalutjqwmbhbvjkj.supabase.co/storage/v1/object/public/avatars/arhimag-avatar.jpg",
  socials: {
...
},
{
  ...
  philosophy: 'Моя творчість поєднує фентезійну естетику з живою емоцією, створюючи персонажів, які оживають на полотні.',
 avatarUrl: "https://oulhpalutjqwmbhbvjkj.supabase.co/storage/v1/object/public/avatars/teka-avatar.jpg",
  socials: {
